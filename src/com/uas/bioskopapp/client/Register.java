...
public class Register extends javax.swing.JFrame {
    ...
    private String username, password, nama, hp;
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        ...
        try {
            sqlcheck = "select * from pelanggan where username = '"+ username+ "'"; 
            kdb.bukaKoneksi();
            koneksi = kdb.getConn();
            ...
            if(Rslogin.next()){
                ...
                sql="INSERT INTO pelanggan(nama, username, pass, no_hp) value"
